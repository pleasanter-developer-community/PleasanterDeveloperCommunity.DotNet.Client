    ...
    public partial class PleasanterClient
    {
            ...
            TimeSpan? timeout = null)
        {
            ...
            return await SendRequestAsync<GetExtensionsResponse>(
                "/api/extensions/get", request, timeout);
        }
            ...
            TimeSpan? timeout = null)
        {
            ...
            return await GetExtensionsAsync(request, timeout);
        }
            ...
            TimeSpan? timeout = null)
        {
            ...
            return await SendRequestAsync<CreateExtensionResponse>(
                "/api/extensions/create", request, timeout);
        }
            ...
            TimeSpan? timeout = null)
        {
            ...
            return await CreateExtensionAsync(request, timeout);
        }
            ...
            TimeSpan? timeout = null)
        {
            ...
            return await SendRequestAsync<UpdateExtensionResponse>(
                $"/api/extensions/{extensionId}/update", request, timeout);
        }
            ...
            TimeSpan? timeout = null)
        {
            ...
            return await UpdateExtensionAsync(extensionId, request, timeout);
        }
            ...
            TimeSpan? timeout = null)
        {
            ...
            return await SendRequestAsync<DeleteExtensionResponse>(
                $"/api/extensions/{extensionId}/delete", request, timeout);
        }
            ...
            TimeSpan? timeout = null)
        {
            ...
            return await DeleteExtensionAsync(extensionId, request, timeout);
        }
