...
// リクエストモデル版
Task<ApiResponse<RecordsResponse>> GetRecordsAsync(long siteId, GetRecordsRequest request, TimeSpan? timeout = null)
Task<ApiResponse<RecordsResponse>> GetAllRecordsAsync(long siteId, GetRecordsRequest request, TimeSpan? timeout = null)
```
