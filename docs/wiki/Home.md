...
詳細なリクエストモデルの使い方（View設定、添付ファイル、メール送信など）については、[リクエストの処理](./00-共通/リクエストの処理.md)を参照してください。
...
API操作に共通する機能やヘルパー機能のドキュメントです。

| ドキュメント                                            | 説明                                                 |
| :------------------------------------------------------ | :--------------------------------------------------- |
| [タイムアウトとキャンセル](./00-共通/タイムアウトとキャンセル.md) | リクエストのタイムアウトとキャンセル処理             |
| [リクエストの処理](./00-共通/リクエストの処理.md)                 | APIリクエストの作成パターン                          |
| [レスポンスの処理](./00-共通/レスポンスの処理.md)                 | APIレスポンスの共通処理パターン                      |
| [ファイルヘルパー](./00-共通/ファイルヘルパー.md)                 | ファイルからBase64/ContentType取得、添付ファイル作成 |
