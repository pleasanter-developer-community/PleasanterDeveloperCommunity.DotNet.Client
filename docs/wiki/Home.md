...
詳細なリクエストモデルの使い方（View設定、添付ファイル、メール送信など）については、[リクエストの処理](00-リクエストの処理)を参照してください。
...
| ドキュメント                                            | 説明                                                 |
| :------------------------------------------------------ | :--------------------------------------------------- |
| [タイムアウトとキャンセル](00-タイムアウトとキャンセル) | リクエストのタイムアウトとキャンセル処理             |
| [リクエストの処理](00-リクエストの処理)                 | APIリクエストの作成パターン                          |
| [レスポンスの処理](00-レスポンスの処理)                 | APIレスポンスの共通処理パターン                      |
| [ファイルヘルパー](00-ファイルヘルパー)                 | ファイルからBase64/ContentType取得、添付ファイル作成 |
