# デモ環境の登録 - demo/register <!-- omit in toc -->
...
```csharp
// リクエストモデル版
Task<ApiResponse<RegisterDemoResponse>> RegisterDemoAsync(RegisterDemoRequest request, TimeSpan? timeout = null, CancellationToken cancellationToken = default)

// パラメータ直接指定版
Task<ApiResponse<RegisterDemoResponse>> RegisterDemoAsync(string mailAddress, TimeSpan? timeout = null, CancellationToken cancellationToken = default)
```
...
| 引数                | 型                  | 必須 | 説明                   |
| ------------------- | ------------------- | :--: | ---------------------- |
| `request`           | RegisterDemoRequest | Yes  | デモ登録リクエスト     |
...
| 引数                | 型                | 必須 | 説明                   |
| ------------------- | ----------------- | :--: | ---------------------- |
| `mailAddress`       | string            | Yes  | メールアドレス         |
| `timeout`           | TimeSpan?         |      | リクエストタイムアウト |
| `cancellationToken` | CancellationToken |      | キャンセルトークン     |
...
| プロパティ    | 型     | 必須 | 説明                                           |
| ------------- | ------ | :--: | ---------------------------------------------- |
| `MailAddress` | string | Yes  | デモ環境のアクセス情報を送信するメールアドレス |
